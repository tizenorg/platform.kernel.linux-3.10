...
/* END TIZEN_Bluetooth */
	...
	__u8			adv_svc_solicit_uuid[HCI_MAX_AD_LENGTH - 5];
	__u8			adv_svc_solicit_uuid_len;
	__u8			adv_svc_comp_16_uuid[HCI_MAX_AD_LENGTH - 5];
	__u8			adv_svc_comp_16_uuid_len;
	__u8			adv_svc_incomp_16_uuid[HCI_MAX_AD_LENGTH - 5];
	__u8			adv_svc_incomp_16_uuid_len;
	__u8			adv_svc_comp_128_uuid[HCI_MAX_AD_LENGTH - 5];
	__u8			adv_svc_comp_128_uuid_len;
	__u8			adv_svc_incomp_128_uuid[HCI_MAX_AD_LENGTH - 5];
	__u8			adv_svc_incomp_128_uuid_len;
	bool			adv_short_local_name;
	bool			adv_complete_local_name;
	bool			adv_tx_power_level;
	__u8			adv_appearance[2];
	bool			adv_appearance_enable;
	__u8			scan_rsp_manufacturer[HCI_MAX_AD_LENGTH - 2];
	__u8			scan_rsp_manufacturer_len;
	__u8			scan_svc_solicit_uuid[HCI_MAX_AD_LENGTH - 2];
	__u8			scan_svc_solicit_uuid_len;
	__u8			scan_svc_comp_16_uuid[HCI_MAX_AD_LENGTH - 2];
	__u8			scan_svc_comp_16_uuid_len;
	__u8			scan_svc_incomp_16_uuid[HCI_MAX_AD_LENGTH - 2];
	__u8			scan_svc_incomp_16_uuid_len;
	__u8			scan_svc_comp_128_uuid[HCI_MAX_AD_LENGTH - 2];
	__u8			scan_svc_comp_128_uuid_len;
	__u8			scan_svc_incomp_128_uuid[HCI_MAX_AD_LENGTH - 2];
	__u8			scan_svc_incomp_128_uuid_len;
	bool			scan_resp_shortened_local_name;
	bool			scan_resp_complete_local_name;
	bool			scan_resp_tx_power_level;
	__u8			scan_resp_appearance[2];
	bool			scan_resp_appearance_enable;

...
static struct samsung_div_clock exynos5x_div_clks[] __initdata = {
	...
	DIV(0, "dout_aclk100_noc", "mout_aclk100_noc", DIV_TOP0, 20, 4),
...
struct pll_pms pll35xx_exynos5422_pms_cpll[] = {
	{.p = 4, .m = 222, .s = 2, .k = 0},
	{.f_out = F_OUT_INVAL},
};

struct pll_pms pll35xx_exynos5422_pms_mpll[] = {
	{.p = 3, .m = 266, .s = 2, .k = 0},
	{.f_out = F_OUT_INVAL},
};

struct pll_pms pll35xx_exynos5422_pms_epll[] = {
	{.p = 2, .m = 100, .s = 1, .k = 0},
	{.p = 3, .m = 200, .s = 2, .k = 0},
	{.p = 3, .m = 200, .s = 3, .k = 0},
	{.p = 5, .m = 301, .s = 3, .k = 3671},
	{.p = 3, .m = 200, .s = 4, .k = 0},
	{.p = 5, .m = 452, .s = 5, .k = 27263},
	{.p = 3, .m = 197, .s = 5, .k = 25690},
	{.p = 3, .m = 181, .s = 5, .k = 24012},
	{.f_out = F_OUT_INVAL},
};

struct pll_pms pll35xx_exynos5422_pms_ipll[] = {
	{.p = 4, .m = 288, .s = 2},
	{.f_out = F_OUT_INVAL},
};

struct pll_pms pll35xx_exynos5422_pms_vpll[] = {
	{.p = 2, .m = 200, .s = 2},
	{.p = 2, .m = 181, .s = 2},
	{.p = 2, .m = 160, .s = 2},
	{.p = 2, .m = 140, .s = 2},
...
struct pll_pms pll35xx_exynos5422_pms_spll[] = {
	{.p = 3, .m = 200, .s = 1},
	{.f_out = F_OUT_INVAL},
};

struct pll_pms pll35xx_exynos5422_pms_rpll[] = {
	{.p = 2, .m = 100, .s = 2},
	{.p = 3, .m = 266, .s = 3},
	{.f_out = F_OUT_INVAL},
};

struct pll_pms pll35xx_exynos5422_pms_bpll[] = {
	{.p = 4, .m = 307, .s = 1},
	{.p = 4, .m = 275, .s = 1},
	{.p = 3, .m = 182, .s = 1},
	{.p = 4, .m = 211, .s = 1},
...
struct pll_pms pll35xx_exynos5422_pms_apll[] = {
	{.p = 2, .m = 200, .s = 0},
	{.p = 6, .m = 575, .s = 0},
	{.p = 3, .m = 275, .s = 0},
	{.p = 2, .m = 175, .s = 0},
...
struct pll_pms pll35xx_exynos5422_pms_kpll[] = {
	{.p = 3, .m = 200, .s = 0},
	{.p = 4, .m = 250, .s = 0},
	{.p = 3, .m = 175, .s = 0},
	{.p = 6, .m = 325, .s = 0},
...
struct pll_pms pll35xx_exynos5422_pms_dpll[] = {
	{.p = 4, .m = 352, .s = 5},
	{.f_out = F_OUT_INVAL},
};
		...
		enum exynos5x_soc soc)
{
	...
	ctx = samsung_clk_init(np, reg_base, CLK_NR_CLKS, NULL, 0, NULL, 0);
	if (!ctx)
	...
	samsung_clk_register_pll2650x("fout_epll", "fin_pll",
			(void __iomem *)(reg_base + 0x10030),
			pll35xx_exynos5422_pms_epll);

	samsung_clk_register_pll2650x("fout_rpll", "fin_pll",
			(void __iomem *)(reg_base + 0x10040),
			pll35xx_exynos5422_pms_rpll);

	samsung_clk_register_pll2550("fout_apll", "fin_pll",
			(void __iomem *)(reg_base), pll35xx_exynos5422_pms_apll,
			0x10);

	samsung_clk_register_pll2550("fout_cpll", "fin_pll",
			(void __iomem *)(reg_base + 0x10020),
			pll35xx_exynos5422_pms_cpll, 0x10);

	samsung_clk_register_pll2550("fout_dpll", "fin_pll",
			(void __iomem *)(reg_base + 0x10030),
			pll35xx_exynos5422_pms_dpll, 0x8);

	samsung_clk_register_pll2550("fout_ipll", "fin_pll",
			(void __iomem *)(reg_base + 0x10060),
			pll35xx_exynos5422_pms_ipll, 0x0);

	samsung_clk_register_pll2550("fout_spll", "fin_pll",
			(void __iomem *)(reg_base + 0x10070),
			pll35xx_exynos5422_pms_spll, 0x0);

	samsung_clk_register_pll2550("fout_vpll", "fin_pll",
			(void __iomem *)(reg_base + 0x10080),
			pll35xx_exynos5422_pms_vpll, 0x0);

	samsung_clk_register_pll2550("fout_mpll", "fin_pll",
			(void __iomem *)(reg_base + 0x10090),
			pll35xx_exynos5422_pms_mpll, 0x0);

	samsung_clk_register_pll2550("fout_bpll", "fin_pll",
			(void __iomem *)(reg_base + 0x20010),
			pll35xx_exynos5422_pms_bpll, 0x10);

	samsung_clk_register_pll2550("fout_kpll", "fin_pll",
			(void __iomem *)(reg_base + 0x28000),
			pll35xx_exynos5422_pms_kpll, 0x10);

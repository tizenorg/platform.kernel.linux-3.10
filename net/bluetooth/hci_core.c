...
struct hci_dev *hci_alloc_dev(void)
{
	...
	hdev->adv_type = 0x00;
	hdev->adv_manufacturer_len = 0x00;
	hdev->adv_svc_solicit_uuid_len = 0x00;
	hdev->adv_svc_comp_16_uuid_len = 0x00;
	hdev->adv_svc_incomp_16_uuid_len = 0x00;
	hdev->adv_svc_comp_128_uuid_len = 0x00;
	hdev->adv_svc_incomp_128_uuid_len = 0x00;
	hdev->scan_rsp_manufacturer_len = 0x00;
	hdev->scan_svc_solicit_uuid_len = 0x00;
	hdev->scan_svc_comp_16_uuid_len = 0x00;
	hdev->scan_svc_incomp_16_uuid_len = 0x00;
	hdev->scan_svc_comp_128_uuid_len = 0x00;
	hdev->scan_svc_incomp_128_uuid_len = 0x00;
	hdev->adv_short_local_name = false;
	hdev->adv_complete_local_name = false;
	hdev->adv_tx_power_level = false;
	hdev->adv_appearance_enable = false;
	hdev->scan_resp_shortened_local_name = false;
	hdev->scan_resp_complete_local_name = false;
	hdev->scan_resp_tx_power_level = false;
	hdev->scan_resp_appearance_enable = false;
#endif

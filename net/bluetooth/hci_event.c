...
#ifdef CONFIG_TIZEN_WIP
bool has_pending_adv_report(struct hci_dev *hdev)
#else
...
#ifdef CONFIG_TIZEN_WIP
void clear_pending_adv_report(struct hci_dev *hdev)
#else
...
#ifdef CONFIG_TIZEN_WIP
void store_pending_adv_report(struct hci_dev *hdev, bdaddr_t *bdaddr,
...
static void hci_vendor_specific_evt(struct hci_dev *hdev, struct sk_buff *skb)
{
	...
	BT_DBG("hci_vendor_specific_evt- RSSI event received");

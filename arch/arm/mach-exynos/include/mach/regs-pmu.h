...
#define S5P_SEQ_TRANSITION0			S5P_PMUREG(0x0220)
#define S5P_SEQ_TRANSITION1			S5P_PMUREG(0x0224)
#define S5P_SEQ_TRANSITION2			S5P_PMUREG(0x0228)

#define S5P_SEQ_COREBLK_TRANSITION0		S5P_PMUREG(0x0260)
#define S5P_SEQ_COREBLK_TRANSITION1		S5P_PMUREG(0x0264)
#define S5P_SEQ_COREBLK_TRANSITION2		S5P_PMUREG(0x0268)
#define S5P_SEQ_COREBLK_TRANSITION3		S5P_PMUREG(0x0270)
#define S5P_SEQ_COREBLK_TRANSITION4		S5P_PMUREG(0x0274)
#define S5P_SEQ_COREBLK_TRANSITION5		S5P_PMUREG(0x0278)
...
#define S5P_ARM_COMMON0_CONFIGURATION		S5P_PMUREG(0x2500)
#define S5P_ARM_COMMON0_STATUS			S5P_PMUREG(0x2504)
#define S5P_ARM_COMMON0_OPTION			S5P_PMUREG(0x2508)
#define S5P_ARM_COMMON_CONFIGURATION(_nr)		\
		(S5P_ARM_COMMON0_CONFIGURATION + ((_nr) * 0x80))
#define S5P_ARM_COMMON_STATUS(_nr)		\
		(S5P_ARM_COMMON0_STATUS + ((_nr) * 0x80))
#define S5P_ARM_COMMON_OPTION(_nr)		\
		(S5P_ARM_COMMON0_OPTION + ((_nr) * 0x80))
...
#define EXYNOS3_CMU_CLKSTOP_TV_SYS_PWR_REG		S5P_PMUREG(0x1144)
...
#define EXYNOS3_PAD_RETENTION_MMC3_SYS_PWR_REG		S5P_PMUREG(0x121C)
...
/* for exynos3 normal power register*/
